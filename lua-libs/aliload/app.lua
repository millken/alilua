...
local Request = require("aliload/request")
local Response = require("aliload/response")
local Pattern = require("aliload/pattern")
local Utils = require("aliload/utils")
local Helper = require("aliload/app/helper")
...
function App:__init(epd, headers, get, cookie, post)
...
function App:run()
  self.request = Request:new(self.__epd, self._headers, self._get, self._cookie, self._post)
  self.response = Response:new()

  self:invoke(self.dispatch)
  self.response:finish(self.__epd, self._headers, self._get, self._cookie, self._post)
